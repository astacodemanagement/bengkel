            ...
            <div class="card">
                <div class="card-header">
                    <div class="date form-inline">
                        ...
                        <button type="button" class="btn btn-primary btn-sm ml-3 btn-filter" style="border-radius: 1rem;">
                            <i class="fa fa-filter"></i> Filter
                        </button>

                        <button type="button" class="btn btn-primary btn-sm ml-3 btn-reset" style="border-radius: 1rem;">
