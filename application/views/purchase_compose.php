        ...
        <div class="content mt-3">
                        ...
                        <table class="table table-bordered" id="purchaseForm">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center"><button type="button" class="btn btn-sm btn-danger btn-del" title="Hapus Item"><i class="fa fa-times"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="text-right mb-4">
                <a href="<?= base_url("purchase"); ?>" class="btn btn-warning" style="border-radius: 1rem;">
                    <i class="fa fa-undo"></i> Cancel

                </a>
                <button class="btn btn-primary btn-save" style="border-radius: 1rem;"><i class="fa fa-save"></i> Simpan</button>
            </div>
        </div>
        ...
        <script>
            ...
            $(".btn-save").on("click", function() {
                ...
                form["description"] = jQuery(".description").val();
                form["total"] = total;
                form["details"] = items;
