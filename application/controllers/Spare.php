...
class Spare extends CI_Controller
{
    ...
    public function json()
    {
        ...
        if (hasPermission('sparepart', 'detail')) {
            $actionDatatable .= '<button type="button" class="btn btn-secondary btn-sm btn-detail" title="Detail Data" data-id="<get-id>" data-kode="<get-kode>" data-name="<get-name>" data-price="<get-price>" data-price1="<get-price1>" data-price2="<get-price2>" data-price3="<get-price3>" data-location="<get-location>" data-description="<get-description>" data-gambar="<get-gambar>"><i class="fa fa-eye"></i></button>';
        }

        if (hasPermission('sparepart', 'edit')) {
            $actionDatatable .= '<button type="button" class="btn btn-primary btn-sm btn-edit ml-1" title="Edit Data" data-id="<get-id>" data-kode="<get-kode>" data-name="<get-name>" data-price="<get-price>" data-price1="<get-price1>" data-price2="<get-price2>" data-price3="<get-price3>" data-location="<get-location>" data-description="<get-description>" data-gambar="[showSparepartImage=<get-gambar>]"><i class="fa fa-edit"></i></button>';
        }

        if (hasPermission('sparepart', 'delete')) {
